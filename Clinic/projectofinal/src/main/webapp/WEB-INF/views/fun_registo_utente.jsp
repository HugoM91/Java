...
<div class="main">
    <div class="container">
        <div class="page-title">
            <h2><img src="/images_web/caminho.svg" alt=""/><span class="title-logo">Registo Utente</span></h2>
        </div>
        <div class="page-content-registo">
            <form action="/fun_registo_utente" class="user-details" method="post">
                <div class="left-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-row form-row-right">
                            ...
                            <input type="text" id="gender" name="genero">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-row form-row-left">
                            <label for="nrsns">Nº Utente Saúde</label><br>
                            <input type="text" id="nrsns" name="sns">
                        </div>
                        <div class="form-row form-row-right">
                ...
                <div class="right-form">
                    ...
                    <div class="form-row">
                        ...
                        <input type="text" class="form-control" id="address" name="morada"><br>
                    </div>
                    <div class="form-group">
                        <div class="form-row form-row-left">
                    ...
                    <footer class="form-submit">
                        <button type="submit" class="btn btn-registar-utente">Registar Utente</button>
                    </footer>
                </div>
            </form>
        </div>
