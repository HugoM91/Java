            ...
            <div class="profile-page-top">
                <div class="personal-details-card">
                    ...
                    <div class="personal-details-card-right">
                        ...
                        <footer>
                            <a href="/update-utente/${utente.getIdUtente()}" class="btn btn-block btn-nova-consulta">Editar
                                Perfil</a>
                        </footer>
                    </div>
                </div>
            ...
            <div class="profile-page-bottom">
                <div class="personal-appointments-history-card">
                    <div class="personal-appointments-history-top">
                        ...
                        <a href="/fun_calendario" class="btn btn-block btn-nova-consulta">Nova Consulta</a>
                    </div>
                        ...
                        <table id="table_fun_consultas_utente" class="table table-borderless">
                            ...
                            <c:forEach var="consultas" items="${consultasList}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="/fun_consulta_details/${consultas.getIdConsulta()}" type="button" class="btn btn-primary btn-md btn-details"><i class="bi bi bi-info-circle"></i></a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
