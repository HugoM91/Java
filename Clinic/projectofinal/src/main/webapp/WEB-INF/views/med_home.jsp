    ...
    <div class="mid-main">
        ...
        <div class="mid-first-container">
            ...
            <button id="mid-first-button">
                <a href="/med_lista_espera">
                    <div id="mid-first-list">VER LISTA DE ESPERA</div>
                </a>
            </button>
        </div>
        <form action="/med_home" method="post">
            <div class="mid-second-container">
                <div id="mid-checkin">Próxima Consulta</div>
                <div id="mid-consulta-info">Detalhes:</div>
                <div id="mid-consulta-next">
                    <p>${proximo.getConsulta().getHora()} - ${proximo.getConsulta().getIdUtente().getNome()}</p>
                </div>
                <input type="hidden" name="idSenha" value="${proximo.getIdSenha()}"/>
                <button type="submit" id="mid-second-button">
                    <div id="mid-second-submit">
                        <i class="fas fa-heartbeat">INICIAR CONSULTA</i>
                    </div>
                </button>
            </div>
        </form>
