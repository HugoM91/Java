...
<div class="main">
    ...
    <div class="mid-main">
        <div class="mid-first-container">
            <img id="mid-wait-img" src="/images_web/scope.svg"/>
            <div id="mid-text-utentes">
                <span id="mid-text-utentes-variable">${medico}</span> MÉDICOS
            </div>
            <div id="mid-text-await">EM SISTEMA</div>
            <div id="mid-text-late"></div>
            <button id="mid-first-button">
                <a href="/admin_medicos">
                    <div id="mid-first-list">VER MÉDICOS</div>
                </a>
            </button>
        </div>
        <div class="mid-first-container">
            <img id="mid-wait-img" src="/images_web/clipboard.svg"/>
            <div id="mid-text-utentes">
                <span id="mid-text-utentes-variable">${funcionario}</span> FUNCIONÁRIOS
            </div>
            <div id="mid-text-await">EM SISTEMA</div>
            <div id="mid-text-late"></div>
            <button id="mid-first-button">
                <a href="/admin_funcionario">
                    <div id="mid-first-list">VER FUNCIONÁRIOS</div>
                </a>
            </button>
        </div>
        <div class="mid-first-container">
            <img id="mid-wait-img" src="/images_web/caminho.svg"/>
            <div id="mid-text-utentes">
                <span id="mid-text-utentes-variable">${utente}</span> UTENTES
            </div>
            <div id="mid-text-await">EM SISTEMA</div>
            <div id="mid-text-late"></div>
            <button id="mid-first-button">
                <a href="/admin_utente">
                    <div id="mid-first-list">VER UTENTES</div>
                </a>
            </button>
        </div>
    </div>
