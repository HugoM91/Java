        ...
        <div class="page-content">
            <div class="calendar-content">
                <div class="ute-calendar">
                    ...
                    <form action="/fun_calendario" method="POST">
                        ...
                        <button type="submit" id="botao-pesquisar">Consultar Vagas</button>
                    </form>
                </div>
                    ...
                    <table id="table_ute_calendario" class="table table-borderless">
                        ...
                        <c:forEach var="nome_lista" items="${vagaList}">
                            <tr>
                                ...
                                <td>
                                    <a href="/fun-nova-consulta/${nome_lista.getId()}" type="button"
