...
<div class="main">
    <div class="leu-container">
        ...
        <h4 id="p-title"> Sala de Espera </h4>
                ...
                <table id="table_fun_consultas" class="table table-borderless">
                    ...
                    <c:forEach var="nome_lista" items="${listaEspera}">
                        <tr>
                            ...
                            <td>${nome_lista.getConsulta().getVaga().getDisponibilidade().getMedico().getNome()} </td>
                            <td><a href="/fun_consulta_details/${nome_lista.getConsulta()}" type="button" class="btn btn-primary btn-md btn-details"><i class="bi bi bi-info-circle"></i></a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
