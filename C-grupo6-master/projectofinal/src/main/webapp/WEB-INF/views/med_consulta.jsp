            ...
            <div class="table-scrollable">
                <table id="table_fun_consultas" class="table table-borderless">
                    ...
                    <tbody class="table-content">
                        <c:forEach var="nome_lista" items="${consultas}">
                            <tr>
                                ...
                                <td>
                                    <a href="/med_consulta_details/${nome_lista.getIdConsulta()}" type="button" class="btn btn-primary btn-md btn-details"><i class="bi bi bi-info-circle"></i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
