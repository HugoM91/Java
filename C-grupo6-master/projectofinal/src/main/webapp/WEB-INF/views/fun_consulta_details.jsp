            ...
            <div class="container">
                ...
                <div class="page-content">
                    ...
                    <div class="consulta-bottom">
                        <form action="/fun_consulta_details/${consulta.getIdConsulta()}" method="post">
                            <button type="submit" class="btn btn-check-in btn-lg"><i class="bi bi-person-check-fill"></i>Check-In</button>
                        </form>
                        <form action="/fun_cancelar_consulta/${consulta.getIdConsulta()}" method="post">
                            <button type="submit" class="btn btn-danger btn-lg"><i class="bi bi-trash"></i>Cancelar</button>
                        </form>
                    </div>
                </div>
            </div>
