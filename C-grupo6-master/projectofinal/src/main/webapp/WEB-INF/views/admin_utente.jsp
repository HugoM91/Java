                            ...
                            <tr>
                                ...
                                <td>
                                    <div id="admin-actions">
                                        <a href="/admin_utente_perfil/${utente.getIdUtente()}" type="button" class="btn btn-primary btn-sm" id="btn-details-admin"><i class="bi bi bi-info-circle"></i></a>
                                        <form action="/admin_utente" method="post">
