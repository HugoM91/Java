...
<div class="main">
    <div class="marcar-container">
        ...
        <div class="page-content-marcar-consulta">
            <div class="form-side">
                <form action="/ute_registar_consulta/${vaga.getId()}" class="nova-consulta" method="post">
                    <div class="form-row">
                        <h5><b>Confirme os detalhes da sua consulta</b></h5>
                    </div>
                    <div class="form-row">
                        <label for="marcar-medico">Médico</label><br>
                        <input type="text"
