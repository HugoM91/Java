                ...
                <div class="page-content">
                    <div class="table-scrollable">
                        <table id="table_fun_consultas" class="table table-borderless">
                            ...
                            <c:forEach var="consulta" items="${consultaList}">
                                <tr>
                                    <td>${consulta.getIdConsulta()}</td>
                                    <td>${consulta.getHora()}</td>
                                    <td>${consulta.getData()}</td>
                                    <td>${consulta.getIdUtente().getNome()} </td>
                                    <td>${consulta.getVaga().getDisponibilidade().getMedico().getTitulo()} ${consulta.getVaga().getDisponibilidade().getMedico().getNome()}</td>
                                    <td>${consulta.getVaga().getDisponibilidade().getMedico().getEspecialidade().getTipo()}</td>
                                    <td>${consulta.getEstado()}</td>
                                    <td>
                                        <a href="/admin_consulta_details/${consulta.getIdConsulta()}" type="button" class="btn btn-primary btn-md btn-details"><i
